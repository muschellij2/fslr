...
#' @description This function calls \code{fslmaths -index}.  
#' The R functions wraps \code{fslmaths}
#' @param file (character) input image to have non-zero entries replaced with index
...
fslindex = function(
  ...
  all.opts = paste("-index ", opts, collapse=" ")
