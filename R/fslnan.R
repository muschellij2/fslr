...
#' @description This function calls \code{fslmaths -nan}.  
#' The R functions wraps \code{fslmaths}
#' @param file (character) input image to replace NaNs (improper numbers) with 0
...
fslnan = function(
  ...
  all.opts = paste("-nan ", opts, collapse=" ")
