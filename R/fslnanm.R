...
#' @description This function calls \code{fslmaths -nanm}.  
#' The R functions wraps \code{fslmaths}
#' @param file (character) input image to set to 1 for NaN voxels, 0 otherwise
...
fslnanm = function(
  ...
  all.opts = paste("-nanm ", opts, collapse=" ")
